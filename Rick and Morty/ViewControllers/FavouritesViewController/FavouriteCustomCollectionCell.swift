...
class FavouriteCustomCollectionCell: UICollectionViewCell {
        
        static let identifier = "FavouriteCustomCollectionCell"
        
        let spinner = UIActivityIndicatorView(style: .gray)
        
        var link = FavouritesViewController()
    ...
    required init?(coder: NSCoder) {
        ...
        @objc func likeButtonTapped(sender: UIButton) {
            ...
            if isLikeTapped {
                ...
                link.removedFromFavourites2(cell: self)
        ...
        func configure(character: Character, episodeText: (String, String)) {
        ...
        private func setupFavouriteUI() {
            ...
            NSLayoutConstraint.activate([
                ...
                //            characterImageView.bottomAnchor.constraint(equalTo: self.episodeUIView.topAnchor,constant: 150),
                ...
                //            characterNameTextLabel.bottomAnchor.constraint(equalTo: self.)
                ...
                //            episodeUIView.topAnchor.constraint(equalTo: characterRaceTextLabel.bottomAnchor,constant: 10),
